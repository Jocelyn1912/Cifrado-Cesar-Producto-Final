/*
*Función con la cúal obtendremos la información del cliente.
*/
function phrase() {
  do { // mediante el bucle do obtendremos la información que necesitamos ejecutar.
...
/*
* Función con la cual en caso de que el cliente haya escogido la opción 1 cifraremos.
*/
function cipher() {
...
/*
*Función com la cual en caso de que el cliente haya escogido la opción 1 cifraremos.
*/
function decipher() {
  do { // mediante el bucle do obtendremos la información que necesitamos ejecutar, osea una frase válida.
    var phrase1 = prompt('Ingrese la frase a cifrar'); // Obteniendo la frase a cifrar,
